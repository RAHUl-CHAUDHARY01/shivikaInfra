...
const Hero = () => {
  ...
  const slides = [
    {
      ...
      subtitle:
        "Approved consultancy for Greater Noida, Noida, and Yamuna Authorities",
      cta: "Get Started",
      bgImage: hero1,
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Industrial spaces, group housing, plotting and farmhouse solutions",
    ...
    },
    {
      ...
      subtitle:
        "Official recognition from Noida, Greater Noida & Yamuna Authorities",
      cta: "Learn More",
      bgImage: hero4,
    },
  ];
  ...
  return (
    ...
    <div className="hidden md:flex items-center justify-center h-[50vh] mt-16">
      <img
        src={logo}
        alt="Logo"
        className="object-contain max-h-full max-w-full px-4"
      />
    </div>

    {/* Text content - below logo, left-aligned on desktop */}
    <div className="pr-6 py-10 md:py-0 md:px-16 md:text-left md:self-start md:max-w-full relative pl-6 md:pl-6">
      <div className="absolute -left-3 sm:-left-6 top-0 bottom-0 w-1 bg-gradient-to-b from-transparent via-black to-transparent md:block"></div>
      ...
      <motion.div
        ...
        className="h-0.5 bg-white mb-3 sm:mb-6 md:ml-0"
      />
      ...
      <motion.h1
        ...
        className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-light mb-3 sm:mb-6"
        style={{
      ...
      <motion.p
        ...
        className="text-sm sm:text-base md:text-lg lg:text-xl mb-5 sm:mb-10 max-w-full sm:max-w-xl md:max-w-2xl md:ml-0"
        style={{
      ...
      <div className="hidden sm:flex absolute bottom-8 right-6 md:right-10 z-20 items-center space-x-4 md:space-x-8">
        ...
        <div className="text-white font-light flex items-center">
          <span
            className="text-xl md:text-3xl font-thin"
            style={{ color: theme.roseGoldLight }}
          >
            {String(currentSlide + 1).padStart(2, "0")}
          </span>
          <span className="mx-1 md:mx-2 text-xs md:text-sm text-white/50">
            —
          </span>
        ...
        <div className="flex items-center">
          ...
          >
            {isAutoPlaying ? (
              <FaPause size={8} className="md:text-xs" />
            ) : (
              <FaPlay size={8} className="md:text-xs" />
            )}
          </button>
