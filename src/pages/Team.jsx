        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto text-left">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-medium text-lg text-[#404040] mb-2">Engineering Excellence</h3>
              <p className="text-gray-600">Our team includes certified engineers with expertise across residential, commercial, and industrial infrastructure projects.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-medium text-lg text-[#404040] mb-2">Project Management</h3>
              <p className="text-gray-600">Seasoned project managers ensure timely delivery, cost optimization, and quality assurance across all our initiatives.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-medium text-lg text-[#404040] mb-2">Design Innovation</h3>
              <p className="text-gray-600">Creative designers and architects work together to develop aesthetically pleasing and functionally superior solutions.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-medium text-lg text-[#404040] mb-2">Technical Support</h3>
              <p className="text-gray-600">Dedicated technicians provide ongoing maintenance and technical guidance throughout project lifecycles.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-medium text-lg text-[#404040] mb-2">Financial Analysis</h3>
              <p className="text-gray-600">Our financial experts ensure project viability and maximize returns on infrastructure investments.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-medium text-lg text-[#404040] mb-2">Client Relations</h3>
              <p className="text-gray-600">Client-focused professionals ensure seamless communication and exceptional service delivery.</p>
            </div>
          </div>
        </div>
      </section>
